...
namespace SAAS_Projectplanningtool.Pages.ArticleManagement
{
    public class ArticleCategoryIndexModel : PageModel
    {
        ...
        public ArticleCategoryIndexModel(ApplicationDbContext context, UserManager<IdentityUser> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            catch (Exception ex)
            {
                return RedirectToPage("/Error",
                    new { id = await _logger.Log(ex, User, null, "ERROR: ArticleCategory/Index<OnGet>") });
            }
        }
    }
}
