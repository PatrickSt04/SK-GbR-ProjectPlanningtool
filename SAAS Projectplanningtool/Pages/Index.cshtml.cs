    ...
    public class Index1Model : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                // Optional: ViewData f�r Fehlermeldung setzen
                ViewData["ErrorMessage"] = "Fehler beim Laden des Dashboards. Bitte versuchen Sie es sp�ter erneut.";
        ...
        private async Task LoadRecentActivities()
        {
            ...
            foreach (var customer in recentCustomers)
            {
                activities.Add(new ActivityDto
                {
                    Description = $"Neuer Kunde '{customer.CustomerName}' wurde hinzugef�gt",
            ...
            foreach (var task in taskDeadlines)
            {
                if (task.EndDate.HasValue)
                {
                    events.Add(new CalendarEventDto
                    {
                        ...
                        Title = $"Aufgabe f�llig: {task.ProjectTaskName}",
                        Type = "Aufgabe"
                    });
                }
            }
